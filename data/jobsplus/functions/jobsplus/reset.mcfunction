...
# This loads all jobs.
function jobsplus:jobsplus/jobs/miner/load
function jobsplus:jobsplus/jobs/farmer/load
function jobsplus:jobsplus/jobs/builder/load
function jobsplus:jobsplus/jobs/hunter/load
function jobsplus:jobsplus/jobs/alchemyst/load
...
function jobsplus:jobsplus/loadstorage