...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.white_terracotta
scoreboard players operation @s jobsplus.p.temp *= white_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.white_terracotta"}'
