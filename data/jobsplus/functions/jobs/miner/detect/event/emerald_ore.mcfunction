...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.emerald_ore
scoreboard players operation @s jobsplus.p.temp *= emerald_ore jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.emerald_ore"}'
