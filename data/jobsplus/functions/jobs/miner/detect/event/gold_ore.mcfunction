...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.gold_ore
scoreboard players operation @s jobsplus.p.temp *= gold_ore jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.gold_ore"}'
