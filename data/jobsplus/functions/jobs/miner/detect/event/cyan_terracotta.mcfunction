...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.cyan_terracotta
scoreboard players operation @s jobsplus.p.temp *= cyan_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.cyan_terracotta"}'
