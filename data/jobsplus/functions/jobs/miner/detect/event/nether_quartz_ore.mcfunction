...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.nether_quartz_ore
scoreboard players operation @s jobsplus.p.temp *= nether_quartz_ore jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.nether_quartz_ore"}'
