...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.orange_terracotta
scoreboard players operation @s jobsplus.p.temp *= orange_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.orange_terracotta"}'
