...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.pink_terracotta
scoreboard players operation @s jobsplus.p.temp *= pink_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.pink_terracotta"}'
