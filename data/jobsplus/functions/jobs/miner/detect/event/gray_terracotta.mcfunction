...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.gray_terracotta
scoreboard players operation @s jobsplus.p.temp *= gray_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.gray_terracotta"}'
