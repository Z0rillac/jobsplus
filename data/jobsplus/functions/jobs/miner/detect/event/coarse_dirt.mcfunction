##
 # ccoarse_dirt.mcfunction
 # jobsplus/jobs/miner/detect/event
 #
 # Created by Zorillac.
##

scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.coarse_dirt
scoreboard players operation @s jobsplus.p.temp *= coarse_dirt jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.coarse_dirt"}'
