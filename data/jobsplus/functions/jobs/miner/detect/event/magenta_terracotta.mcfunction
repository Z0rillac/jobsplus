...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.magenta_terracotta
scoreboard players operation @s jobsplus.p.temp *= magenta_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.magenta_terracotta"}'
