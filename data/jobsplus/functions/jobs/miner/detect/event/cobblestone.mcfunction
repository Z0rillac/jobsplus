...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.cobblestone
scoreboard players operation @s jobsplus.p.temp *= cobblestone jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.cobblestone"}'
