...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.redstone_ore
scoreboard players operation @s jobsplus.p.temp *= redstone_ore jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.redstone_ore"}'
