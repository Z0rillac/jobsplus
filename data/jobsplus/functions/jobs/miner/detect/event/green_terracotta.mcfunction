...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.green_terracotta
scoreboard players operation @s jobsplus.p.temp *= green_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.green_terracotta"}'
