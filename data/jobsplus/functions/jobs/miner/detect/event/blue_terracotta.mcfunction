...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.blue_terracotta
scoreboard players operation @s jobsplus.p.temp *= blue_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.blue_terracotta"}'
