...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.coal_ore
scoreboard players operation @s jobsplus.p.temp *= coal_ore jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.coal_ore"}'
