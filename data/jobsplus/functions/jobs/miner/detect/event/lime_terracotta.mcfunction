...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.lime_terracotta
scoreboard players operation @s jobsplus.p.temp *= lime_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.lime_terracotta"}'
