...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.glowstone
scoreboard players operation @s jobsplus.p.temp *= glowstone jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.glowstone"}'
