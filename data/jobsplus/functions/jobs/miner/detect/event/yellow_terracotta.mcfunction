...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.yellow_terracotta
scoreboard players operation @s jobsplus.p.temp *= yellow_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.yellow_terracotta"}'
