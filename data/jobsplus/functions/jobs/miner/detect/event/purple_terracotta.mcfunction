...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.purple_terracotta
scoreboard players operation @s jobsplus.p.temp *= purple_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.purple_terracotta"}'
