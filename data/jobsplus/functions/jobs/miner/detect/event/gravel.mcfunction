...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.gravel
scoreboard players operation @s jobsplus.p.temp *= gravel jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.gravel"}'
