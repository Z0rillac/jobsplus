...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.andesite
scoreboard players operation @s jobsplus.p.temp *= andesite jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.andesite"}'
