...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.iron_ore
scoreboard players operation @s jobsplus.p.temp *= iron_ore jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.iron_ore"}'
