...
scoreboard players operation @s jobsplus.p.temp = @s jobsplus.mined.brown_terracotta
scoreboard players operation @s jobsplus.p.temp *= brown_terracotta jobsplus.m.cfg
...
data modify storage jobsplus:temp root.slot.0 set value '{"translate":"block.minecraft.brown_terracotta"}'
